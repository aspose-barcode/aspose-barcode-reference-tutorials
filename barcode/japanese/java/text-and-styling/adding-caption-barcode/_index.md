...
## Aspose.BarCode でキャプションを追加するメリットは？
...
## ステップ 2: バーコード ジェネレーター インスタンスの作成
...
### バーコード キャプションのフォント スタイルをカスタマイズできますか？
はい、上部と下部のキャプションそれぞれのフォントファミリー、サイズ、カラーをカスタマイズできます。

### Aspose.BarCode は、さまざまなバーコード シンボル体系に対応していますか？
