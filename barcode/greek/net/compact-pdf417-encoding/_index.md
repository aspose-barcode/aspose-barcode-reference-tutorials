...
- **Διόρθωση Σφαλμάτων:** Το PDF417 χρησιμοποιεί διόρθωση σφαλμάτων Reed‑Solomon· μπορείτε να επιλέξετε ένα επίπεδο από **0 to 8**. Τα υψηλότερα επίπεδα αυξάνουν τον πλεονασμό, κάτι που είναι χρήσιμο σε σκληρά περιβάλλοντα όπως η βιομηχανική σάρωση.  
