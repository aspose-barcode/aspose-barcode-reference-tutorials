...
Compact PDF417 Encoding — это высокоёмкностный 2‑D штрих‑код, который хранит большие объёмы данных в компактной области. Он располагает информацию в строки и столбцы кодовых слов, применяя коррекцию ошибок Рида‑Соломона, чтобы данные оставались читаемыми даже при повреждении части символа. За счёт удаления лишних отступов полученный символ меньше, чем у стандартного PDF417, при этом сохраняет ту же надёжность.
