...
Có, Aspose.BarCode cho Java là một sản phẩm thương mại. Bạn có thể tìm chi tiết về giấy phép **[here](https://purchase.aspose.com/buy)**.

### Có bản dùng thử miễn phí không?
Có, bạn có thể nhận bản dùng thử miễn phí **[here](https://releases.aspose.com/)**.

### Tôi có thể tìm tài liệu cho Aspose.BarCode cho Java ở đâu?
Tài liệu có sẵn **[here](https://reference.aspose.com/barcode/java/)**.

### Làm thế nào để tôi nhận được hỗ trợ cho Aspose.BarCode cho Java?
Truy cập **[Aspose.BarCode forum](https://forum.aspose.com/c/barcode/13)** để được hỗ trợ.
